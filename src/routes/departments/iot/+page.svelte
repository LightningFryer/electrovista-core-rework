...
<main
	class="dotted-background-wrapper !bg-iot-primary text-iot-accent flex h-screen flex-col items-center justify-center"
>
	<div class="flex h-full w-full flex-col">
		<div class="flex h-[20%] flex-col items-center justify-center p-32">
			<h1 class="iot-card-title font-bebas text-9xl" style:--iot-title-text="iot-title-text">
				Internet of Things
			</h1>
		</div>
	</div>
