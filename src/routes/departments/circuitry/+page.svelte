...
<main
	class="dotted-background-wrapper text-[#737373] flex min-h-screen flex-col items-center justify-center !bg-[#d4d4d4]"
>
	<div class="flex h-full w-full flex-col">
		<div class="flex h-[20%] flex-col items-center justify-center pt-28 pb-12">
			<h1
				class="robotronics-card-title text-[#737373] font-bebas text-9xl"
		...
		<div class="flex flex-col items-center">
			<div class="flex flex-col items-center gap-y-2">
				...
				<div class="avatar">
					<div class="ring-[#737373] ring-offset-[#d4d4d4] w-24 rounded-full ring-4 ring-offset-2">
						<img
		...
		<div class="flex h-screen flex-col gap-y-2">
			...
			<div class="flex w-full grow flex-row items-center justify-center gap-x-4">
				<div class="card bg-[#d4d4d4] h-[60%] w-[40%]">
					<div class="card-body">
						...
						<div class="card-actions justify-end">
							<label for="my_modal_6" class="btn bg-[#737373] border-none shadow-none text-white">Read More</label>
						</div>
					</div>
				</div>
				...
				<div class="card bg-[#d4d4d4] h-[60%] w-[40%]">
					<div class="card-body">
						...
						<div class="card-actions justify-end">
							<button class="btn bg-[#737373] border-none shadow-none text-white">Read More!</button>
						</div>
					</div>
				</div>
			</div>
