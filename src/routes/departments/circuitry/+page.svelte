...
<main
	class="dotted-background-wrapper !bg-circuitry-primary text-circuitry-accent flex h-screen flex-col items-center justify-center"
>
	<div class="flex h-full w-full flex-col">
		<div class="flex h-[20%] flex-col items-center justify-center p-32">
			<h1
				class="circuitry-card-title font-bebas text-9xl"
